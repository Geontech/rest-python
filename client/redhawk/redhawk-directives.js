...
angular.module('redhawkDirectives', ['RecursionHelper', 'webSCAServices', 'ui.bootstrap'])
    ...
    .directive('properties', function(PropertyProcessorService) {
      return {
        ...
        templateUrl: '/client/redhawk/redhawk-templates/properties.html',
    ...
    .directive('property', function(PropertyProcessorService){
      return {
        ...
        templateUrl: '/client/redhawk/redhawk-templates/property.html',
        compile: PropertyProcessorService.compile
      }
    })
    .directive('status', function(){
      return {
        ...
        templateUrl: '/client/redhawk/redhawk-templates/status.html'
      }
    })
    ...
    .directive('waveform', ['RedhawkREST', 'RedhawkDomain', function(RedhawkREST, RedhawkDomain){
      return {
        ...
        templateUrl: '/client/redhawk/redhawk-templates/waveform.html',
    ...
    .directive('component', ['RedhawkREST', 'RedhawkDomain', function(RedhawkREST, RedhawkDomain){
      return {
        ...
        templateUrl: '/client/redhawk/redhawk-templates/component.html',
        link: function(scope, element, attrs) {
    ...
    .directive('device', ['RedhawkDomain', function(RedhawkDomain){
      return {
        ...
        templateUrl: '/client/redhawk/redhawk-templates/device.html',
        link: function(scope, element, attrs) {
    ...
    .directive('fileSystem', ['RedhawkConfig','RedhawkDomain', '$modal',
      ...
      return {
        ...
        templateUrl: '/client/redhawk/redhawk-templates/file-system.html',
        link: function(scope, element, attrs) {
          ...
          scope.fileViewer = function(path) {
            ...
            $modal.open({
              templateUrl: '/client/redhawk/redhawk-templates/file-viewer.html',
